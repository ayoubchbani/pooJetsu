...
mot clé 'abstract' ====> 
0 . Une classe abstraite est une classe qui peut contenir des méthodes abstraites (c'est-à-dire des méthodes déclarées sans corps).
    Elle peut également contenir des méthodes concrètes avec une implémentation.
